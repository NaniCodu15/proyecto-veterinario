                ...
                <div class="historia-detalle">
                    ...
                    <div class="historia-detalle__body">
                        <div class="historia-detalle__tabs" role="tablist" aria-label="Secciones de la historia clínica">
                            ...
                            @endif
                            <button type="button" class="historia-detalle__tab {{ $isAsistente ? '' : 'is-active' }}" id="tabListadoConsultas" data-tab-target="consultas" role="tab" aria-controls="panelListadoConsultas" aria-selected="{{ $isAsistente ? 'false' : 'true' }}" tabindex="{{ $isAsistente ? '-1' : '0' }}">
                        ...
                        <section id="panelListadoConsultas" class="historia-detalle__panel historia-detalle__panel--consultas {{ $isAsistente ? '' : 'is-active' }}" data-tab-content="consultas" role="tabpanel" aria-labelledby="tabListadoConsultas" @if (!$isAsistente) @else hidden aria-hidden="true" @endif>
                            <div class="historia-detalle__section-header">
