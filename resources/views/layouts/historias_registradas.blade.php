                ...
                <div class="historia-detalle">
                    ...
                    <div class="historia-detalle__body">
                        <div class="historia-detalle__tabs" role="tablist" aria-label="Secciones de la historia clínica">
                            ...
                            @endif
                            <button type="button" class="historia-detalle__tab @if($userRole !== 'asistente') is-active @endif" id="tabListadoConsultas" data-tab-target="consultas" role="tab" aria-controls="panelListadoConsultas" aria-selected="{{ $userRole === 'asistente' ? 'false' : 'true' }}" tabindex="{{ $userRole === 'asistente' ? '-1' : '0' }}">
                        ...
                        <section id="panelListadoConsultas" class="historia-detalle__panel historia-detalle__panel--consultas @if($userRole !== 'asistente') is-active @endif" data-tab-content="consultas" role="tabpanel" aria-labelledby="tabListadoConsultas" @if($userRole === 'asistente') hidden aria-hidden="true" @else aria-hidden="false" @endif>
                            <div class="historia-detalle__section-header">
